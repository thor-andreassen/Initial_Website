...
Thor Andreassen Personal Website
## Overview
This project contains a personal website for Thor E. Andreassen a postdoctoral research fellow in orthopaedic biomechanics at the Mayo Clinic.
This project contains html code and helper functions that are the basis for the webpages.
The webpages include an about me, download links to papers, virtual 3d models, and videos
There are a series of webpages with different information on them.
## Tech Stack
...
## Rules & Guardrails (Do Not Break)
- Never edit files in the Papers, STLs, or Videos folders
- Never edit the source files for images, videos, 3d geometries etc.
- Always ensure that code written for webpages will work for desktop, Android, and IPhone
